    ...
    <nav class="bg-white shadow-lg">
            ...
            <div class="flex justify-between">
                <div class="flex space-x-7">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        <a href="contact.html" class="py-4 px-2 text-blue-500 border-b-4 border-blue-500 font-semibold">Contact</a>
                    </div>
                </div>
        ...
        <div class="hidden mobile-menu">
            <ul>
                ...
                <li><a href="contact.html" class="block text-sm px-2 py-4 text-white bg-blue-500 font-semibold">Contact</a></li>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 text-center" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-blue-500 font-semibold">
                        123 Rue des Cartes<br>75001 Paris, France
                    </p>
                </div>
            </div>
                ...
                <div class="space-y-8" data-aos="fade-left">
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="h-64 bg-gray-300 relative">
                            <iframe 
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2624.9916256937595!2d2.3412!3d48.8566!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66e1f06e2b005%3A0x40b82c3688c9460!2sParis%2C%20France!5e0!3m2!1sen!2sus!4v1234567890123"
                                width="100%" 
                                height="100%" 
                                style="border:0;" 
                                allowfullscreen="" 
                            ...
                            <div class="space-y-3">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 text-sm">Samedi : 10h00 - 17h00</p>
