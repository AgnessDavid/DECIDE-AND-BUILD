    ...
    <nav class="bg-white shadow-lg">
            ...
            <div class="flex justify-between">
                <div class="flex space-x-7">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        <a href="boutique.html" class="py-4 px-2 text-blue-500 border-b-4 border-blue-500 font-semibold">Boutique</a>
        ...
        <div class="hidden mobile-menu">
            <ul>
                ...
                <li><a href="boutique.html" class="block text-sm px-2 py-4 text-white bg-blue-500 font-semibold">Boutique</a></li>
