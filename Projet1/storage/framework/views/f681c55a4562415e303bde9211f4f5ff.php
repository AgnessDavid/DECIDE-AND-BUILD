<?php if(auth()->check()): ?>
    ...
    <script>
        const socket = new WebSocket(
            'ws://<?php echo e(config('filament-push-notifications.socket.host')); ?>:<?php echo e(config('filament-push-notifications.socket.port')); ?>?key=<?php echo e(config('filament-push-notifications.socket.key')); ?>'
            );
        ...
        const handleConnected = (data) => {
            fetch('http://<?php echo e(config('filament-push-notifications.socket.host')); ?>:<?php echo e(config('filament-push-notifications.socket.port')); ?>/sockeon/auth', {
                method: 'POST',
                body: JSON.stringify({
        ...
        function showNotification(notificationData) {
            const notificationDataWithDefaults = {
                title: notificationData.title ||
                    '<?php echo e(config('filament-push-notifications.native_notification.defaults.title')); ?>',
                message: notificationData.message ||
                    '<?php echo e(config('filament-push-notifications.native_notification.defaults.message')); ?>',
                type: notificationData.type ||
                    '<?php echo e(config('filament-push-notifications.native_notification.defaults.type')); ?>',
                ...notificationData
            };
        ...
        function createNativeNotification(notificationData) {
            const config = <?php echo json_encode(config('filament-push-notifications.native_notification'), 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH /home/agnessdavid/workspace/LARAVEL/DECIDE AND BUILD/Projet1/vendor/xentixar/filament-push-notifications/resources/views/notification.blade.php ENDPATH**/ ?>